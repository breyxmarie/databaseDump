...
CREATE TABLE `profiling` (
  ...
  `common_sys` int NOT NULL,
  `common_dia` int NOT NULL,
  `hypertension` tinyint(1) NOT NULL,
  `dateofBP` date NOT NULL,
  `takingMeds` tinyint(1) NOT NULL,
  `targetCalories` int NOT NULL,
  `user_id_id` int NOT NULL,
  PRIMARY KEY (`profiling_id`),
  KEY `profiling_user_id_id_f898a4aa_fk_user_user_id` (`user_id_id`),
  CONSTRAINT `profiling_user_id_id_f898a4aa_fk_user_user_id` FOREIGN KEY (`user_id_id`) REFERENCES `user` (`user_id`)
